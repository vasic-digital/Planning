# Planning - AI planning algorithms module: HiPlan, MCTS, Tree of Thoughts.
...
challenge:
	../challenges/scripts/planning_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Planning - AI planning algorithms module: HiPlan, MCTS, Tree of Thoughts."
	@echo ""
	@echo "Build & Test:"
